...
func (in *KeycloakRealmSpec) DeepCopyInto(out *KeycloakRealmSpec) {
	*out = *in
	...
	if in.UserFederationProvidersSecrets != nil {
		in, out := &in.UserFederationProvidersSecrets, &out.UserFederationProvidersSecrets
		*out = make([]*UserFederationProvidersSecret, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(UserFederationProvidersSecret)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserFederationProvidersSecret) DeepCopyInto(out *UserFederationProvidersSecret) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserFederationProvidersSecret.
func (in *UserFederationProvidersSecret) DeepCopy() *UserFederationProvidersSecret {
	if in == nil {
		return nil
	}
	out := new(UserFederationProvidersSecret)
